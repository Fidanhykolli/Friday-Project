...
while (index < numeriArray.length && numeriArray[index] !== 32) {
  console.log(numeriArray[index]);
  index++;
}
/* ESERCIZIO 10
...
function posizioneNellAlfabeto(carattere) {
...
for (let i = 0; i < charactersArray.length; i++) {
  ...
  const posizione = posizioneNellAlfabeto(carattere);
  posizioniArray.push(posizione);
}
